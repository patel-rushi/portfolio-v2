    ...
    def index
        @work = [
            { 
                ...
                description: [
                    'In November 2021, I joined Explorator Labs as a part-time developer. I first got introduced to RoR (Ruby on Rails) during this time. I under vent personal training on RoR until February 2022. Thereafter, I started working on actual client projects where I begin with writing test cases using Cypress.',
