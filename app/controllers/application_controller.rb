  ...
  def set_home_blog_posts
    ...
    @home_blog_posts = {
      ...
      link_managing_projects: {
        ...
        published_at: '',
        content: '',
        embed: '<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7127790487771525120" height="250" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>',
      },
